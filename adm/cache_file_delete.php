                ...
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <p class='bg-warning' style='padding:15px;'>
                            ...
                            echo '<div class="local_desc01 local_desc bg-success" style="padding:15px;"><p><strong style="color:red;" >최신글 캐시파일 '.$cnt.'건 삭제 완료됐습니다.</strong><br>프로그램의 실행을 끝마치셔도 좋습니다.</p></div>'.PHP_EOL;
                            ?>
