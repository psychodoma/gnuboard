                        ...
                        <div id="sms5_send">
                            ...
                            <div id="send_write">
                                ...
                                <div id="write_reply">
                                    ...
                                    <input type="text" name="wr_reply" value="<?php echo $sms5['cf_phone']?>" id="wr_reply" required class="form-control frm_input required" size="17" maxlength="20" readonly="readonly">
                                </div>

                                <div id="write_recv" class="write_inner">
                                    <h2>받는사람</h2>
                                    <button type="button" class="write_floater write_floater_btn btn btn-default" onclick="hp_list_del()">선택삭제</button>
                                    ...
                                    <div id="recv_add">
                                        ...
                                        <input type="text" name="hp_name" id="hp_name" class="form-control frm_input" size="11" maxlength="20" onkeypress="if(event.keyCode==13) document.getElementById('hp_number').focus();"><br>
                                        <label for="hp_number">번호</label>
                                        <input type="text" name="hp_number" id="hp_number" class="form-control frm_input" size="11" maxlength="20" onkeypress="if(event.keyCode==13) hp_add()">
                                        <button type="button" class='btn btn-default' onclick="hp_add()">추가</button><br>
                                    </div>
                                </div>
