...
<form name="emo_frm">
    <select class='form-control' name="fg_no" id="emo_sel">
...
<br>
<input type="text" name="sv" value="<?php echo $sv?>" id="sv" required class="form-control frm_input required" size="15"><br>
