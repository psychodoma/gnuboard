                ...
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <input type="hidden" name="get_fg_no" value="<?php echo $fg_no?>">
                            ...
                            <tbody>
                            <tr>
                                <th scope="row"><label for="fg_no">그룹<span class="required red"> *</span></label></th>
                                <td>
                                    <select name="fg_no" id="fg_no" required class="form-control required">
                            ...
                            <tr>
                                <th scope="row"><label for="fo_name">제목<span class="required red"> *</span></label></th>
                                <td><input type="text" name="fo_name" id="fo_name" required value="<?php echo $write['fo_name']?>" class="form-control frm_input required" size="70"></td>
                            </tr>
                            <tr>
                                <th scope="row">메세지</th>
                                <td id="sms5_emo_add">
                            ...
                            <div class="btn_confirm01 btn_confirm">
                                ...
                                <a class='btn btn-default' href="./form_list.php?<?php echo clean_query_string($_SERVER['QUERY_STRING']); ?>">목록</a>
                            </div>
                        </form>
