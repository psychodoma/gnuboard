        ...
        <div class='row' >
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <p class='bg-danger' style='padding:15px;'><strong>주의!</strong> 메뉴설정 작업 후 반드시 <strong>확인</strong>을 누르셔야 저장됩니다.</p>
                        ...
                        <form name="fmenulist" id="fmenulist" method="post" action="./menu_list_update.php" onsubmit="return fmenulist_submit(this);">
                            ...
                            <button type="button" onclick="return add_menu();" class='btn btn-default'>메뉴추가<span class="sound_only"> 새창</span></button>
                                ...
                                <tr>
                                    ...
                                    for ($i=0; $row=sql_fetch_array($result); $i++)
                                    {
                                        ...
                                        if(strlen($row['me_code']) == 4) {
                                            ...
                                            $sub_menu_info = '<img src = "/adm/img/sub_menu_ico.gif">';
                                    ...
                                    <tr class="<?php echo $bg; ?> menu_list menu_group_<?php echo substr($row['me_code'], 0, 2); ?>">
                                        <td class="td_category<?php echo $sub_menu_class; ?>">
                                            ...
                                            <!-- <label for="me_name_<?php echo $i; ?>" class="sound_only"><?php echo $sub_menu_info; ?></label> -->
                                            <div class='input-group' >
                                            <div class='input-group-addon' ><?=$sub_menu_info?></div>
                                            <input type="text" name="me_name[]" value="<?php echo $me_name; ?>" id="me_name_<?php echo $i; ?>" required class="required frm_input full_input form-control">
                                            </div>
                                        </td>
                                        <td>
                                            
                                            <input type="text" name="me_link[]" value="<?php echo $row['me_link'] ?>" id="me_link_<?php echo $i; ?>" required class="required frm_input full_input form-control">
                                        </td>
                                        <td class="td_mng">
                                            
                                            <select class='form-control' name="me_target[]" id="me_target_<?php echo $i; ?>">
                                        ...
                                        <td class="td_num">
                                            ...
                                            <input type="text" name="me_order[]" value="<?php echo $row['me_order'] ?>" id="me_order_<?php echo $i; ?>" class="frm_input form-control" size="5">
                                        </td>
                                        <td class="td_mng">
                                          
                                            <select class='form-control' name="me_use[]" id="me_use_<?php echo $i; ?>">
                                        ...
                                        <td class="td_mng">
                                            ...
                                            <select class='form-control' name="me_mobile_use[]" id="me_mobile_use_<?php echo $i; ?>">
                                        ...
                                        <td class="td_mng" style='vertical-align: inherit;' >
                                            <?php if(strlen($row['me_code']) == 2) { ?>
                                            <button type="button" class="btn_add_submenu btn btn-default">추가</button>
                                            <?php } ?>
                                            <button type="button" class="btn_del_menu btn btn-default">삭제</button>
                                        </td>
                                    </tr>
                                    <?php
                                    }
                            ...
                            <div class="btn_confirm01 btn_confirm">
                                <input type="submit" name="act_button" value="확인" class="btn_submit btn btn-default">
                            </div>
