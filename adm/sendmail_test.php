                ...
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        if (isset($_POST['email'])) {
                            ...
                            echo '<section class="bg-success" style="padding:15px;">';
                            echo '<h2>결과메세지</h2>';
                        ...
                        <fieldset id="fsendmailtest">
                            ...
                            <label for="email">받는 메일주소<span class="required red"> *</span></label>
                            ...
                            <br>
                            <input type="submit" value="발송" class="btn_submit btn btn-default">
                        </fieldset>
                        </form>
                        <br>
