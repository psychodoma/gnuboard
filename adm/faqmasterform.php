                        ...
                        <div class="tbl_frm01 tbl_wrap table-responsive">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <input type="text" name="fm_order" value="<?php echo $fm['fm_order']; ?>" id="fm_order" class="frm_input form-control" maxlength="10" size="10">
                                </td>
                            </tr>
                            <tr>
                                <th scope="row"><label for="fm_subject">제목</label></th>
                                <td>
                                    <input type="text" value="<?php echo get_text($fm['fm_subject']); ?>" name="fm_subject" id="fm_subject" required class="form-control frm_input required"  size="70">
                                    <?php if ($w == 'u') { ?>
                                        <br>
                                    <a href="<?php echo G5_BBS_URL; ?>/faq.php?fm_id=<?php echo $fm_id; ?>" class="btn btn-default btn_frmline">보기</a>
                                    <a href="./faqlist.php?fm_id=<?php echo $fm_id; ?>" class="btn_frmline btn btn-default">상세보기</a>
                                    <?php } ?>
                                </td>
                            </tr>
                            <tr>
