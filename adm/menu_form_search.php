...
?>
    ...
    <tr>
        ...
        <td class="td_mngsmall">
            ...
            <button type="button" class="add_select btn btn-default"><span class="sound_only"><?php echo $row['subject']; ?> </span>선택</button>
        </td>
    </tr>
...
<div class="btn_win02 btn_win">
    <button type="button" class="btn_cancel btn btn-default" onclick="window.close();">창닫기</button>
</div>
...
<div class="tbl_frm01 tbl_wrap">
    <table class="table table-striped table-bordered" >
        ...
        <tr>
            <th scope="row"><label for="me_name">메뉴<span class="required red"> *</span></label></th>
            <td><input type="text" name="me_name" id="me_name" required class="frm_input required form-control"></td>
        </tr>
        <tr>
            <th scope="row"><label for="me_link">링크<span class="required red"> *</span></label></th>
            <td>
                <?php echo help('링크는 http://를 포함해서 입력해 주세요.'); ?>
                <input type="text" name="me_link" id="me_link" required class="frm_input full_input required form-control">
            </td>
        </tr>
...
<div class="btn_win02 btn_win">
    <button type="button" id="add_manual" class="btn_submit btn btn-default">추가</button>
    <button type="button" class="btn_cancel btn btn-default" onclick="window.close();">창닫기</button>
</div>
<?php } ?>