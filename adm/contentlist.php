                ...
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <p class="btn_add01 btn_add">
                            <a class='btn btn-default' href="./contentform.php">내용 추가</a>
                        </p>
                        ...
                        <div class="tbl_head01 tbl_wrap table-responsive">
                            ...
                            <tr class="<?php echo $bg; ?>">
                                ...
                                <td class="td_mng">
                                    <a class='btn btn-default' href="./contentform.php?w=u&amp;co_id=<?php echo $row['co_id']; ?>">수정</a>
                                    <a class='btn btn-default' href="<?php echo G5_BBS_URL; ?>/content.php?co_id=<?php echo $row['co_id']; ?>">보기</a>
                                    <a class='btn btn-default' href="./contentformupdate.php?w=d&amp;co_id=<?php echo $row['co_id']; ?>" onclick="return delete_confirm(this);">삭제</a>
                                </td>
                            </tr>
                            <?php
                            }
