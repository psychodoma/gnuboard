                ...
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <p class="local_ov01 local_ov bg-info" style='padding:15px;'>
                            <?php if ($page > 1) {?><a class='btn btn-default' href="<?php echo $_SERVER['SCRIPT_NAME']; ?>">처음으로</a><?php } ?>
                            <span>전체 FAQ <?php echo $total_count; ?>건</span>
                        </p>

                        <ol class="local_desc01 local_desc bg-success" style='padding:15px 30px;'>
                        ...
                        <p class="btn_add01 btn_add">
                            <a href="./faqmasterform.php" class='btn btn-default'>FAQ추가</a>
                        </p>
                        ...
                        <div class="tbl_head01 tbl_wrap table-responsive">
                            ...
                            <tr class="<?php echo $bg; ?>">
                                ...
                                <td><a class='btn btn-default' href="./faqlist.php?fm_id=<?php echo $row['fm_id']; ?>&amp;fm_subject=<?php echo $row['fm_subject']; ?>"><?php echo stripslashes($row['fm_subject']); ?></a></td>
                                <td class="td_num"><?php echo $cnt; ?></td>
                                <td class="td_num"><?php echo $row['fm_order']?></td>
                                <td class="td_mng">
                                    <a class='btn btn-default' href="./faqmasterform.php?w=u&amp;fm_id=<?php echo $row['fm_id']; ?>">수정</a>
                                    <a class='btn btn-default' href="<?php echo G5_BBS_URL; ?>/faq.php?fm_id=<?php echo $row['fm_id']; ?>">보기</a>
                                    <a class='btn btn-default' href="./faqmasterformupdate.php?w=d&amp;fm_id=<?php echo $row['fm_id']; ?>" onclick="return delete_confirm(this);">삭제</a>
                                </td>
                            </tr>
                            <?php
                            }
