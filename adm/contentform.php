                    ...
                    <div class="x_content">
                        ...
                        <div class="tbl_frm01 tbl_wrap table-responsive">
                            ...
                            <tr>
                                ...
                                <td>
                                    <p><?php echo help('20자 이내의 영문자, 숫자, _ 만 가능합니다.'); ?></p>
                                    <input type="text" value="<?php echo $co['co_id']; ?>" name="co_id" id ="co_id" required <?php echo $readonly; ?> class="form-control required <?php echo $readonly; ?> frm_input" size="20" maxlength="20">
                                    <?php if ($w == 'u') { ?><br><a href="<?php echo G5_BBS_URL; ?>/content.php?co_id=<?php echo $co_id; ?>" class="btn btn-default btn_frmline">내용확인</a><?php } ?>
                                </td>
                            </tr>
                            <tr>
                                <th scope="row"><label for="co_subject">제목</label></th>
                                <td><input type="text" name="co_subject" value="<?php echo htmlspecialchars2($co['co_subject']); ?>" id="co_subject" required class="form-control frm_input required" size="90"></td>
                            </tr>
                            <tr>
                                <th scope="row">내용</th>
                            ...
                            <tr>
                                ...
                                <td>
                                    <p><?php echo help("내용에서 iframe 등의 태그를 사용하려면 사용안함으로 선택해 주십시오."); ?></p>
                                    <select class='form-control' name="co_tag_filter_use" id="co_tag_filter_use">
                            ...
                            <tr>
                                ...
                                <td>
                                    <p><?php echo help("설정값이 없으면 기본 상단 파일을 사용합니다."); ?></p>
                                    <input type="text" name="co_include_head" value="<?php echo $co['co_include_head']; ?>" id="co_include_head" class="form-control frm_input" size="60">
                                </td>
                            </tr>
                            <tr>
                                <th scope="row"><label for="co_include_tail">하단 파일 경로</label></th>
                                <td>
                                    <p><?php echo help("설정값이 없으면 기본 하단 파일을 사용합니다."); ?></p>
                                    <input type="text" name="co_include_tail" value="<?php echo $co['co_include_tail']; ?>" id="co_include_tail" class="form-control frm_input" size="60">
                                </td>
                            </tr>
                            <tr>
